...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, RESET_DSP_Pin|DC_DSP_Pin|BLK_DSP_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RESET_DSP_Pin DC_DSP_Pin BLK_DSP_Pin */
  GPIO_InitStruct.Pin = RESET_DSP_Pin|DC_DSP_Pin|BLK_DSP_Pin;
